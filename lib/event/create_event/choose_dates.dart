...
import 'package:havruta_project/event/create_event/second_dot_row.dart';
import 'package:syncfusion_flutter_sliders/sliders.dart';
import '../../globals.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../buttons/my_progress_button.dart';
import 'choose_dates_algo.dart';
import '../screens/create_event_screen/create_event_administration_details.dart';
...
class _ChooseDates extends State<ChooseDates> {
  ...
  DateTime? lastDate = DateTime.now().add(Duration(days: 1));
  String? frequency = "חד פעמי";
              ...
              onPressed: () async {
                ...
                if (isDatesValid(firstDate, time, lastDate!, context)) {
                  ...
                  var nextPage = () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CreateEventAdministrationDetails(
                                    event: widget.event)),
                      );
                  // -- check for overlap
