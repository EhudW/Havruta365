              ...
              children: <Widget>[
                Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Positioned(
                        top: -(Globals.scaler.getHeight(3)),
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: Globals.scaler.getWidth(5)),
                  child: Column(
                            ...
                            child: OutlineButton(
                              ...
                              child: Center(
                                child: Text(
                                  "כניסה",
                                  style: TextStyle(
                                      color: Colors.white, fontSize: Globals.scaler.getTextSize(7)),
                                ),
                              ),
                            ),
                          )),
                      ...
                      FadeAnimation(
                          ...
                          GestureDetector(
                            ...
                            child: Center(
                                child: Text(
                              "משתמש חדש",
                              style: TextStyle(color: Colors.grey, fontSize: Globals.scaler.getTextSize(7)),
                            )),
                          )),
                      SizedBox(
                        height: Globals.scaler.getHeight(1),
