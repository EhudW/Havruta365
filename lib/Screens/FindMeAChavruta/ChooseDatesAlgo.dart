...
List<DateTime> calcDates(DateTime dateStart, TimeOfDay timeStart, DateTime dateEnd, int frequency){
  List<DateTime> dates = [];
  // First day with start time
  DateTime first = new DateTime(dateStart.year, dateStart.month, dateStart.day, timeStart.hour, timeStart.minute);
  dates.add(first);
